...
/**
 * A test suite for testing the method in {@link KafkaContainerAutomatCommandProcessor}
 ...
 */
@SpringBootTest(classes = KafkaContainerAutomatCommandProcessor.class, webEnvironment = SpringBootTest.WebEnvironment.NONE)
@ActiveProfiles("kafka")
class KafkaContainerAutomatCommandProcessorTests {
    ...
    @Test
    void kafka_containerautomat_command_processor_bean_is_available() {

        assertNotNull(containerAutomatCommandProcessor);
        assertInstanceOf(KafkaContainerAutomatCommandProcessor.class, containerAutomatCommandProcessor);
    }
