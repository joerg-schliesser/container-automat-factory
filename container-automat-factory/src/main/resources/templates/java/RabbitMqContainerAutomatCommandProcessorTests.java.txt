...
/**
 * A test suite for testing the method in {@link RabbitMqContainerAutomatCommandProcessor}
 ...
 */
@SpringBootTest(classes = RabbitMqContainerAutomatCommandProcessor.class, webEnvironment = SpringBootTest.WebEnvironment.NONE)
@ActiveProfiles("rabbitmq")
class RabbitMqContainerAutomatCommandProcessorTests {
    ...
    @Test
    void rabbitmq_containerautomat_command_processor_bean_is_available() {

        assertNotNull(containerAutomatCommandProcessor);
        assertInstanceOf(RabbitMqContainerAutomatCommandProcessor.class, containerAutomatCommandProcessor);
    }
